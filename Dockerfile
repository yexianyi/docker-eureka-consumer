...
ARG SOURCE_PATH_1=$SOURCE_PATH/chukonu-springcloud-eureka-consumer
ARG TARGET_JAR_NAME=chukonu-springcloud-eureka-consumer.jar
...
ADD https://api.github.com/repos/yexianyi/docker-springcloud-eureka-consumer/git/refs/heads/master version.json
